...
library(EnvStats)
# start_hurdle_gamma1 <- function(x,p0M,nB){
#   x0 = x[x==0]
#   x1 = sort(x[x>0])
#   xM = x1[1:round(p0M*nB)]
#   xU = x1[-(1:round(p0M*nB))]
#   
...
#   lambdaU = 1 - lambdaM
#   
#   return(list(lambda = c(lambdaM, lambdaU), p0 = c(p0M, p0U), alpha = c(paramM[1], paramU[1]), beta = c(paramM[2], paramU[2])))
# }
